...
In unusual cases, the `NetworkX Steering Council`_ may be asked to decide
whether a controversial NXEP is ``Accepted``.
...
.. _NetworkX Steering Council:
   https://networkx.github.io/dev/governance/governance.html
